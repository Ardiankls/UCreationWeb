...
<nav class="navbar shadow col-11 navbar-expand-lg navbar-light bg-light rounded-3" style="margin-left: 1em; margin-top: 0.5em;  "  >
    <div class="container-fluid">
        ...
        <a class="navbar-brand" style="color:#979BFF;" href="#">UCreation</a>
        <a class="navbar-brand current-page" style="color:#979BFF; font-family: 'Roboto Medium'; font-size: 1em; margin-right: 2em;">| Project List</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item btn  " style="background-color: #7965FF; margin-right: 1em ">
                    <a class="nav-link " style="color: white;" href="#">Upload Project</a>
                </li>
                <li class="nav-item btn   " style="background-color: #7965FF; margin-right: 1em ">
...
<div class="container-fluid " >
<div class="card-cointainer d-inline">
<div class="card-view bg-white shadow rounded-3 mx-auto" style="width: 200px; height: 267px; margin-top: 50px;">
    <div class="image-cover rounded-3 mx-auto " style="padding: 2px; background-color: lightpink; width: auto; height: 120px;"></div>
