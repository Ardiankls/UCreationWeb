...
@section('content')
    ...
    <div class="container-sm text-center">
        <img src="{{asset('image/creation/'.$creation->picture)}}" class="img-fluid" style=" max-width: 50%; text-align:center; padding: 2px ;margin: 0 auto;  margin-top: 10px; border-radius: 15px;">
    </div>
